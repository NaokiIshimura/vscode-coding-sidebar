...
| 項目 | 手順 |
| --- | --- |
| タスク作成 | Directory Listタイトルメニューの左端のタスクアイコンをクリック<br>フォルダ名を入力してルートパスに作成<br>新しいディレクトリ内にタイムスタンプ付きのMarkdownファイルが自動作成され、Markdown Editor Viewで開かれます |
| フォルダ作成 | Directory Listタイトルメニューまたは右クリックメニューのフォルダアイコンをクリック<br>フォルダ名を入力して作成<br>マークダウンファイルは作成されません - シンプルなディレクトリ作成用です |
