...
| **Menu** | ユーザ設定を開く<br>グローバル設定を開く<br>テンプレートをカスタマイズ<br>ショートカット機能: ターミナルを開く、デフォルトブランチへ切り替え、Git pull<br>**Beta Features**: Task Panelでエディタ領域にDocs & Editorを表示 |
...
| **親ディレクトリナビゲーション** | 親ディレクトリリンク（".."）がワークスペース内であれば常に表示され、親ディレクトリへの移動が容易。 |
