...
AIコーディングツール（Claude Code、Cursor、GitHub Copilot等）との連携を強化するためのサイドバー拡張機能です。
ワークスペース内のファイルとフォルダを効率的に閲覧・管理し、AIとのコーディング作業をスムーズにします。
...
- **フォルダツリー設定**: フォルダツリーviewから設定画面を開き、デフォルトの相対パスを直接編集
