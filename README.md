...
| **Menu** | Open user or global settings.<br>Customize templates.<br>Quick shortcuts: Open terminal, Checkout default branch, Git pull.<br>**Beta Features**: Open Task Panel to view Docs & Editor in the editor area. |
