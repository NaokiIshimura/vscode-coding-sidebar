...
Welcome to AI Coding Panel! This guide will help you get started quickly.

## Opening the Panel

1. Click the "AI Coding Panel" icon in the activity bar
2. Or press `Cmd+Shift+A` (macOS) / `Ctrl+Shift+A` (Windows/Linux)
...
5. **Iterate**: Edit and run again as needed

## Quick Tips

- Use `Cmd+M` to quickly create a new markdown file
- Right-click directories to access context menu actions
- Archive completed tasks to keep workspace clean
- Customize templates for consistent file creation
